...
import { type Options, checkDockerStatus, getDockerOverview, getTopContainers, getPerformanceWarning, getLatestLog, listContainers, getContainerDetails, getContainerLogs, startContainer, stopContainer, restartContainer, listDockerImages, listDockerVolumes, getContainerVolumes, getDockerNetworksOverview, getDockerNetworkMap } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { CheckDockerStatusData, GetDockerOverviewData, GetTopContainersData, GetPerformanceWarningData, GetLatestLogData, ListContainersData, GetContainerDetailsData, GetContainerLogsData, StartContainerData, StartContainerError, StartContainerResponse, StopContainerData, StopContainerError, StopContainerResponse, RestartContainerData, RestartContainerError, RestartContainerResponse, ListDockerImagesData, ListDockerVolumesData, GetContainerVolumesData, GetDockerNetworksOverviewData, GetDockerNetworkMapData } from '../types.gen';
